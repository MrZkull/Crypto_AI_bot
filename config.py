...
TIER_LIQ1   = ["SOLUSDT", "AVAXUSDT", "NEARUSDT", "MATICUSDT", "TRXUSDT", "SUIUSDT", "APTUSDT", "ATOMUSDT"]
TIER_INST   = ["LINKUSDT", "DOTUSDT", "UNIUSDT", "XRPUSDT", "LTCUSDT", "BCHUSDT", "ALGOUSDT", "AAVEUSDT"]
TIER_AI_MOM = ["ADAUSDT", "DOGEUSDT"]
...
MAX_SAME_DIRECTION = 6      # max 2 BUY or 2 SELL simultaneously but for performance monitor i have changed to 6 will revert back to 3 in mainet
